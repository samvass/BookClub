...
Given('a user with username {string} and password {string} is logged in', async (string, string2) => {
...
When('username {string} requests to view book recommendations', function (string) {
    // Write code here that turns the phrase above into concrete actions
