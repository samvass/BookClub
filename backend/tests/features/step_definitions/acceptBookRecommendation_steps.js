...
When('user {string} accepts the book with title {string} recommendation', async (string, string2) => {
    // find sessionID
...
When('the user accepts the book with title {string} recommendation', async (string) => {
    // accept book
